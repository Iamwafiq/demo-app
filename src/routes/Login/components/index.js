    ...
    <div  className={loginPage}>
      <div  className={loginBox}>
        ...
        <div className={fields}>
          <TextBox name="email" className={input} value={email} type="email" placeholder="Enter Email" onChange={setEmail}/>
          <TextBox name="password" className={input} value={password} type="password" placeholder="Enter Password" onChange={setPassword}/>
          <Button className={button} click={loginUser}>
            Login
          </Button>
          <Button className={button} click={register}>
            Register
          </Button>
        </div>
      </div>
